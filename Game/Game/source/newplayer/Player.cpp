...
void Player::Render() {
	...
	//DrawSphere3D(_senterpos, _r, 16, color, color, false);
	...
	//i = VGet(i.x, _vPos.y + _colSubY, i.z);
	//DrawLine3D(a, b, color);

	//auto Matrix = MGetRotVec2(VGet(0.0f, 0.0f, 1.0f), VGet(1.0f, 0.0f, 0.0f));
	auto Matrix = MGetRotY(Math::ToRadians(90));
		//MGetRotAxis(VGet(0.0f, 1.0f, 0.0f), Math::ToRadians(90));
